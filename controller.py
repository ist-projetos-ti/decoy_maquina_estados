...
def newstate_function(dataValues):
    ...
    if state["seguranca"][0] == "Ligada":
        ...
        if dataValues["inputs"]["emergencia"] == 1:
            ...
            newstate["armazenamento"] = ["Parada", True]
            #print('d1')
        ...
        if dataValues["inputs"]["emergencia"]==0 and dataValues["inputs"]["restart"] == 0:
            ...
            newstate["armazenamento"] = ["Espera", True]
    ...
    if state["esteiras"][0] == "Espera":
        ...
        # if dataValues["inputs"]["temp"]<dataValues["settings"]["tempInoculacaoMax"]:
        if dataValues["inputs"]["s3"] == 0 and temperatura <= 30:  # Linha de teste enquanto não tem o sensor de temperatura, simulando 
            newstate["esteiras"] = ["Aciona atuador", True]
        ...
        if dataValues["inputs"]["at1open"] == 0 and dataValues["inputs"]["s2"] == 0 and pdataValues["local"]["stop"] == 0:
            newstate["esteiras"] = ["Liga m1", True]
    ...
    if state["esteira3"][0] == "Espera":
        #print("entra aqui ali 2 espera")
        if dataValues["inputs"]["s6"] == 1 and dataValues["inputs"]["c"] < 4:
            newstate["esteira3"] = ["Atuador Direita", True]
        
        elif dataValues["inputs"]["s6"] >= 1 and dataValues["inputs"]["c"] > 4:
            newstate["esteira3"] = ["Atuador Esquerda", True]

    elif state["esteira3"][0] == "Atuador Direita":
        if dataValues["inputs"]["c"] >= 6:
            newstate["esteira3"] = ["Incremento elevador", True]

        elif dataValues["inputs"]["c"] < 6 and dataValues["inputs"]["at3direita"] == 1:
        ...
        elif dataValues["inputs"]["s6"] > 0 and dataValues["inputs"]["at3esquerda"] == 1:
            newstate["esteira3"] = ["Espera", True]        
...
JSdataValues = '{"outputs": {"e1": "", "alarme": "", "at1": "", "bi": "", "mv1": "", "mr1": "", "bp": "", ' \
               '"fim_placas": "", "at2": "", "mv2": "", "mr2": "", "fim_tampas": "", "at3": "", "me": "", ' \
               '"fim_elevador": ""}, "inputs": {"sp1": "", "sp2": "", "emergencia": "", "restart": "", ' \
               '"tempInoculacao": "", "biRetorno": "", "s3": "", "at1open": "", "at1close": "", "s1": "", "s2": "", ' \
               '"bpRetorno": "", "s4": "", "s5": "", "at2open": "", "at2close": "", "se": "", "at3direita": "", ' \
               '"at3esquerda": ""}, "local": {"portas": "", "seguranca": "", "qtdPlacas": "", "qtdTampas": "", ' \
               '"qtdPlacasProntas": "", "nivelElevadorMaxElevador": ""}, "settings": {"tempInoculacaoMax": "", ' \
               '"nivelElevadorMax": ""}, "state": {"seguranca": ["Parada", true], "esteiras": ["Espera", true], ' \
               '"alimentacao": ["Espera", true], "alimentacao2": ["Espera", true], "armazenamento": ["Espera", true]}}';
